                        ...
                        <div className="w-48 h-48 md:w-56 md:h-56 relative flex items-center justify-center overflow-visible">
                            ...
                            >
                                <motion.path
                                    ...
                                    fill="none"
                                    strokeLinecap="round"
                                    initial={{ pathLength: 0, d: "M 70 15 C 90 35 90 65 70 85" }} // Normal Bow
                                    animate={{ 
                                        pathLength: 1,
                                        d: [
                                            "M 70 15 C 90 35 90 65 70 85", // Normal
                                            "M 70 15 C 105 35 105 65 70 85", // Stretched
                                            "M 70 15 C 90 35 90 65 70 85"  // Release
                                        ]
                                    }}
                                    transition={{ 
                                        pathLength: { duration: 1, ease: "circOut", delay: 0.2 },
                                        d: { duration: 1.2, times: [0, 0.8, 1], delay: 1.2, ease: "easeInOut" }
                                    }}
                                />
                            </motion.svg>
                            ...
                            <motion.div
                                ...
                                initial={{ x: 0 }}
                                animate={{ 
                                    x: [0, -15, -15, 300], // Pull back -> Hold -> Shoot!
                                    opacity: [1, 1, 1, 0]
                                }}
                                transition={{ 
                                    duration: 1.5, 
                            ...
                            {/* Central Glow point (Release Spark) */}
                            <motion.div
                                ...
                                animate={{ 
                                    opacity: [0, 1, 0], 
                                    scale: [0, 4, 0],
                                    x: [0, 50] // Move with arrow slightly
                                }}
                                transition={{ 
                                    duration: 0.4, 
                                    delay: 2.3, // Hits right as arrow shoots
                                    ease: "easeOut"
                                }}
                            />
                        </div>
